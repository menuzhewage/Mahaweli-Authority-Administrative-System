...
class Complainthandlerpage extends StatefulWidget {
  const Complainthandlerpage({super.key});

  @override
  State<Complainthandlerpage> createState() => _ComplainthandlerpageState();
}

class _ComplainthandlerpageState extends State<Complainthandlerpage> {
                        ...
                        child: Card(
                          ...
                          child: const Center(
                            child: Column(
                              ...
                              children: [
                                Text('Complaint History Management'),
                                Text('Complaint Resolving Progress Track'),
                                Text('Register New Complaints'),
                                Text('Assign Tasks')
                              ],
                            ),
                          ),
